...
var GifViewer = /** @class */ (function () {
    ...
    GifViewer.prototype.decodeImageDataBuffer = function (bufferArray, minCodeSize, colorTable, transparentColorIndex) {
        ...
        return output.split(',').reduce(function (acc, cur) {
            acc.push(__assign(__assign({}, colorTable[cur]), { a: (parseInt(cur) === transparentColorIndex) ? 0 : 1 }));
            return acc;
        }, []);
    };
    /**
    ...
    GifViewer.prototype.decodeImageData = function (arraybuffer, colorTable, transparentColorIndex) {
        ...
        // 总图像数据
        var buffer = ArrayBuffers.reduce(function (acc, cur) {
            acc.buffer.set(new Uint8Array(cur), acc.byteLength);
            acc.byteLength += cur.byteLength;
            return acc;
        }, { buffer: new Uint8Array(imageDataBuffersLength), byteLength: 0 }).buffer;
        // 解码图像数据
        var colors = this.decodeImageDataBuffer(buffer, minCodeSize, colorTable, transparentColorIndex);
        return {
            byteLength: byteLength,
    ...
    GifViewer.prototype.decodeSubImages = function (subImageBuffer) {
        ...
        while (flag !== TRAILER_FLAG) {
            ...
            if (flag === EXTENSION_FLAG) {
                ...
                // 解码子图像数据
                var imageData = this.decodeImageData(imageDataBuffer, colorTable, graphicsControlExtension.transparentColorIndex);
    ...
    GifViewer.prototype.decode = function (file) {
        return __awaiter(this, void 0, void 0, function () {
            var arrayBuffer, byteLength, headerBuffer, logicalScreenBuffer, _a, globalColorTableFlag, globalColorTableSize, globalColorTableLength, globalColorTableBuffer, globalColorTableColors, subImageBuffer, subImages;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        subImages = this.decodeSubImages(subImageBuffer);
                        byteLength += subImages.byteLength;
                        return [2 /*return*/, Object.assign(this.gif, { byteLength: byteLength, subImages: subImages })];
                }
            });
        });
    };
